...
const logoDisplay = computed(() => {
    return configStore.fullLogoUrl || logoDefault;
});
const toggleTheme = () => {
...
onMounted(() => {
    ...
    if(!configStore.isLoaded) configStore.fetchConfig();
});
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom mb-4 px-3 minimal-card">
        <div class="container-fluid">
            <router-link to="/" class="navbar-brand d-flex align-items-center py-0">
                <img :src="logoDisplay" alt="Logo" height="45" class="d-inline-block align-text-top" style="object-fit: contain;">
            </router-link>
